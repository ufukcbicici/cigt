...
from cigt_refactoring_for_dpp import CigtClean
...
class FashionMnistLenetCigtBayesianOptimizer(BayesianOptimizer):
    def __init__(self, init_points, n_iter):
        ...
        # "information_gain_balance_coefficient": 2.2046547575536195,
        # "lr_initial_rate": 0.02724501107998208,
        # "random_routing_ratio": 0.5147808578421542,
        # "temperature_decay_rate": 0.999824075661547},
        # "datetime": {"datetime": "2024-02-14 01:24:53", "elapsed": 0.005347, "delta": 0.000121}}
    ...
    def cost_function(self, **kwargs):
        ...
        model = CigtClean(model_definition="Clean Cigt",
